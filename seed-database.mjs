...
if (!process.env.DATABASE_URL) {
  throw new Error("DATABASE_URL must be set for seeding the database");
}
...
// Import the schema from a dynamic import to handle ESM
const schemaImport = await import('./shared/schema.js');
const {
  departments,
  positions,
  employees,
